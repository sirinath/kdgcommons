...
/**
 *  A layout manager designed for building input forms. Provides the following
 *  features:
 *  
 *  <ul>
...
implements LayoutManager2
{
    ...
    /** 
     *  Convenience constructor that allows user to specify the number of columns
    ...
    /** 
     *  Convenience constructor that allows specification of horizontal and
     *  vertical gaps between components. Alignment defaults to left-horizontal
     *  and center vertical.
     *
     *  @param  cols    Number of columns in the layout.
...
//----------------------------------------------------------------------------
    ...
    /** 
     *  Used by layout managers that associated constraints with components.
     *  We don't, so this is a no-op that will never be called.
     */
    ...
    /** 
     *  Called when the container removes a component from the layout.
     */
    ...
    /** 
     *  Called by the contaienr to arrange its components.
     */
